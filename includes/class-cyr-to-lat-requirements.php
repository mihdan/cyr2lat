	...
	public function php_requirement_message() {
		...
		<div class="message error">
			<p>
				...
				echo esc_html( sprintf( __( 'Your server is running PHP version %1$s but Cyr To Lat %2$s requires at least %3$s.', 'cyr2lat' ), phpversion(), CYR_TO_LAT_VERSION, CYR_TO_LAT_MINIMUM_PHP_REQUIRED_VERSION ) );
				?>
			</p>
		</div>
		<?php
