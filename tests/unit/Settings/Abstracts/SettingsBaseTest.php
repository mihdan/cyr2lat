...
class SettingsBaseTest extends CyrToLatTestCase {
	 ...
	 */
	public function test_constructor( bool $is_tab ): void {
	 ...
	 * @return array
	 */
	public static function dp_test_constructor(): array {
		return [
			'Tab'       => [ true ],
			'Not a tab' => [ false ],
		];
	 ...
	 * @throws ReflectionException ReflectionException.
	 */
	public function test_init( bool $is_active, bool $script_debug ): void {
	 ...
	 * @return array
	 */
	public static function dp_test_init(): array {
		return [
	 ...
	 * @throws ReflectionException ReflectionException.
	 */
	public function test_is_main_menu_page( string $parent_slug, bool $expected ): void {
		$subject = Mockery::mock( SettingsBase::class )->makePartial();
		$subject->shouldAllowMockingProtectedMethods();
	 ...
	 * @return array
	 */
	public static function dp_test_is_main_menu_page(): array {
		return [
			'Empty slug' => [ '', true ],
	 ...
	 * @return array
	 */
	public static function dp_test_init_settings(): array {
		return [
	 ...
	 * @return array
	 */
	public static function dp_test_form_fields(): array {
		return [
	 ...
	 * @return array
	 */
	public static function dp_test_add_settings_page(): array {
		return [
			'Main menu page' => [ true ],
			'Submenu page'   => [ false ],
		];
	 ...
	 * @return array
	 */
	public static function dp_test_setup_sections(): array {
		return [
			'No tabs'   => [ [] ],
			'Some tabs' => [ [ 'some tab' ] ],
		];
	 ...
	 */
	public function test_setup_tabs_section(): void {
		$tab_option_page = 'cyr-to-lat';
	 ...
	 * @throws ReflectionException ReflectionException.
	 */
	public function test_tabs_callback(): void {
		$option_page        = 'cyr-to-lat';
	 ...
	 */
	public function test_is_tab_active( $on_page, $input_tab, $referer_tab, bool $is_tab, string $class_name, bool $expected ): void {
	 ...
	 * @return array
	 */
	public static function dp_test_is_tab_active(): array {
		return [
	 ...
	 * @return array
	 */
	public static function dp_test_get_tab_name_from_referer(): array {
		return [
			'Not ajax, not a tab'  => [
				false,
	 ...
	 * @return array
	 */
	public static function dp_test_field_callback(): array {
		return array_merge(
	 ...
	 * @return array
	 */
	private static function dp_wrong_field_callback(): array {
		return [
			'Wrong type' => [
				[
					'label'        => 'some label',
	 ...
	 * @return array
	 */
	private static function dp_text_field_callback(): array {
		return [
			'Text'                   => [
				[
					'label'        => 'some label',
	 ...
	 * @return array
	 */
	private static function dp_password_field_callback(): array {
		return [
			'Password' => [
				[
					'label'        => 'some label',
	 ...
	 * @return array
	 */
	private static function dp_number_field_callback(): array {
		return [
			'Number' => [
				[
					'label'        => 'some label',
	 ...
	 * @return array
	 */
	private static function dp_text_area_field_callback(): array {
		return [
			'Textarea' => [
				[
					'label'        => 'some label',
	 ...
	 * @return array
	 */
	private static function dp_check_box_field_callback(): array {
		return [
	 ...
	 * @return array
	 */
	private static function dp_radio_field_callback(): array {
		return array_merge(
	 ...
	 * @return array
	 */
	private static function dp_empty_radio_field_callback(): array {
		return [
	 ...
	 * @return array
	 */
	private static function dp_not_empty_radio_field_callback(): array {
		return [
			'Radio buttons' => [
				[
					'label'        => 'radio buttons',
	 ...
	 * @return array
	 */
	private static function dp_select_field_callback(): array {
		return [
	 ...
	 * @return array
	 */
	private static function dp_multiple_field_callback(): array {
		return array_merge(
	 ...
	 * @return array
	 */
	private static function dp_empty_multiple_field_callback(): array {
		return [
	 ...
	 * @return array
	 */
	private static function dp_not_empty_multiple_field_callback(): array {
		return [
			'Multiple'                         => [
				[
					'label'        => 'multiple',
	 ...
	 * @return array
	 */
	private static function dp_table_field_callback(): array {
		return [
	...
	public function test_get( array $settings, string $key, $empty_value, $expected ): void {
		...
		if ( ! isset( $settings[ $key ] ) ) {
			$subject->shouldReceive( 'form_fields' )->andReturn( self::get_test_settings() )->once();
		}
	 ...
	 * @return array
	 */
	public static function dp_test_get(): array {
	 ...
	 * @return array
	 */
	public static function dp_test_field_default(): array {
		return [
			'Empty field'        => [ [], '' ],
	 ...
	 * @return array
	 */
	public static function dp_test_update_option(): array {
		return [
			'Empty key'         => [
				self::get_test_settings(),
				'',
	 ...
	 * @return array
	 */
	public static function dp_test_pre_update_option_filter(): array {
		return [
			[
				[],
				[ 'value' ],
	 ...
	 */
	public function test_is_options_screen( $current_screen, bool $is_main_menu_page, bool $expected ): void {
	 ...
	 * @return array
	 */
	public static function dp_test_is_options_screen(): array {
		return [
	...
	public function test_is_options_screen_when_get_current_screen_does_not_exist(): void {
		FunctionMocker::replace(
			...
			static function ( $func ) {
				return 'get_current_screen' !== $func;
			}
		);
